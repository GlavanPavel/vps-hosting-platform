...
\newcommand{\thesistitle}   {Platformă de provizionare și management VPS}
%<---------
\newcommand{\authorlast}    {GLAVAN}         %<---------
\newcommand{\authorfirst}   {Pavel}
...
\newcommand{\coordinator}   {șef lucr.~dr.~ing.\\Silviu Dumitru PAVĂL}
